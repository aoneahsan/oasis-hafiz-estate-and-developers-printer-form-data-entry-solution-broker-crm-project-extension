...
const InvoicesForm: React.FC = () => {
  ...
  const { invoiceId, invoiceType } = useParams({
    strict: false
  }) as { invoiceId?: string; invoiceType?: ZInvoiceTypeE };
    ...
    () => ({
      user: {
        ...
        company_number:
          ...
          ZUserRState?.registration_number ??
          '',
        vat_number:
                          ...
                          <div className='flex items-start justify-between w-full'>
                            <div className='w-full'>
                              ...
                              isZNonEmptyStrings([
                                ...
                                <span className='block font-medium mt-1 text-[.95rem] font-roboto-regular'>
                                  {values?.user?.city}, {values?.user?.country}
                                </span>
                              ) : null}
                              <span className='block font-medium mt-1 text-[.95rem] font-roboto-regular'>
                                {values?.user?.country}
                            ...
                            >
                              {values?.client !== null ? (
                                <div className='w-full block ms-8 font-medium my-4 text-[.95rem] font-roboto-regular'>
                                  ...
                                  {isZNonEmptyString(
                                    values?.client?.registration_number
                                  ) ? (
                                    <span className='block font-medium mt-1 text-[.95rem] font-roboto-regular'>
                                      Company Number:{' '}
                                      {values?.client?.registration_number}
