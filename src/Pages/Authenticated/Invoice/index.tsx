...
const Invoices: React.FC = () => {
  ...
  let invoiceType = ZInvoiceTypeE.inv;
  try {
    const { invoiceType: _invoiceType } = useParams({
      from: AppRoutes.authRoutes.invoices
    });
    invoiceType = _invoiceType as ZInvoiceTypeE;
  } catch (error) {}
            ...
            <div className='pt-1 overflow-auto mt-7'>
              <div className='w-[64.4375rem]'>
                <table className='w-full text-sm text-left text-tertiary'>
                  ...
                  <tbody>
                    {zInvoicesDataRStateSelector?.data?.length > 0 &&
                          ...
                          >
                            <td>
                              <div className='overflow-hidden text-ellipsis line-clamp-1'>
                                {el?.invoice_no || constants.noValueFound}
                              </div>
                            </td>
                            <td>
                              <div className='overflow-hidden text-ellipsis line-clamp-1'>
                                {el?.user?.company || constants.noValueFound}
                              </div>
                            </td>
                            <td>
                              <div className='overflow-hidden text-ellipsis line-clamp-1'>
                            ...
                            <td>
                              <div className='overflow-hidden text-ellipsis line-clamp-1'>
                                {el?.total || constants.noValueFound}
                              </div>
                            </td>
                            <td>
                              <div className='overflow-hidden text-ellipsis line-clamp-1'>
                ...
                <div className='flex justify-center mt-5 items-center w-full py-[.4rem]'>
                  <div className='w-1/2'>
                    <span className='font-normal ps-4 text-primary text-[1rem] leading-[120%] font-roboto-medium'>
                      ...
                      {zInvoicesDataRStateSelector?.data?.length} results
                    </span>
                  </div>
